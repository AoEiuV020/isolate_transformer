...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _AddStreamState$(controller, source, cancelOnError, $T) {
      var t1 = $.Zone__current,
        t2 = $T._eval$1("~(0)")._as(controller.get$_add(controller)),
    ...
    Stream_asyncExpand_closure: function Stream_asyncExpand_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.$this = t1;
      this.convert = t2;
    },
    Stream_asyncExpand__closure: function Stream_asyncExpand__closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _.$this = t1;
      _.convert = t2;
    ...
    findPrimeNumbersListTransform(numStream) {
      return type$.Stream_Map_dynamic_dynamic._as(numStream).asyncExpand$1$1(new A.findPrimeNumbersListTransform_closure(), type$.List_dynamic);
    },
    mergeResult(input, count, $T) {
      return A.mergeResult$body(input, count, $T, $T._eval$1("List<0>"));
    },
    mergeResult$body(input, count, $T, $async$type) {
      var $async$mergeResult = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              buffer = A._setArrayType([], t1);
              t2 = new A._StreamIterator(A.checkNotNullable(input, "stream", type$.Object), $T._eval$1("_StreamIterator<0>"));
              $async$handler = 3;
            case 6:
              // for condition
              $async$temp1 = A;
              $async$goto = 8;
              return A._asyncStarHelper(t2.moveNext$0(), $async$mergeResult, $async$controller);
            case 8:
              ...
              value = t2.get$current(0);
              J.add$1$ax(buffer, value);
              $async$goto = J.get$length$asx(buffer) === count ? 9 : 10;
              break;
            case 9:
              // then
              $async$goto = 11;
              $async$nextWhenCanceled = [1, 4];
              return A._asyncStarHelper(A._IterationMarker_yieldSingle(buffer), $async$mergeResult, $async$controller);
            case 11:
              // after yield
              buffer = A._setArrayType([], t1);
            case 10:
            ...
            case 4:
              ...
              $async$handler = 2;
              $async$goto = 12;
              return A._asyncStarHelper(t2.cancel$0(0), $async$mergeResult, $async$controller);
            case 12:
              // returning from await.
            ...
            case 5:
              // after finally
              $async$goto = J.get$length$asx(buffer) !== 0 ? 13 : 14;
              break;
            case 13:
              // then
              $async$goto = 15;
      ...
      var $async$goto = 0,
        $async$controller = A._makeAsyncStarStreamController($async$mergeResult, $async$type),
        $async$nextWhenCanceled, $async$handler = 2, $async$currentError, $async$next = [], value, t1, buffer, t2, $async$temp1;
      return A._streamOfController($async$controller);
    },
    findPrimeNumbers(from, count) {
      var $async$findPrimeNumbers = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        switch ($async$errorCode) {
          case 2:
            $async$next = $async$nextWhenCanceled;
            $async$goto = $async$next.pop();
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              if (from < 0)
                throw A.wrapException(A.Exception_Exception("from\u4e0d\u80fd\u662f\u8d1f\u6570"));
              num = from, found = 0;
            case 3:
              // for condition
              if (!(found < count)) {
              ...
              $async$goto = A.isPrime(num) ? 5 : 6;
              break;
            case 5:
              // then
              $async$goto = 7;
              $async$nextWhenCanceled = [1];
              return A._asyncStarHelper(A._IterationMarker_yieldSingle(num), $async$findPrimeNumbers, $async$controller);
            case 7:
              // after yield
              ++found;
            case 6:
      ...
      var $async$goto = 0,
        $async$controller = A._makeAsyncStarStreamController($async$findPrimeNumbers, type$.int),
        $async$nextWhenCanceled, $async$handler = 2, $async$currentError, $async$next = [], num, found;
      return A._streamOfController($async$controller);
    },
    isPrime(n) {
      var i;
      ...
      if (n <= 3)
        return true;
      if (B.JSInt_methods.$mod(n, 2) === 0 || B.JSInt_methods.$mod(n, 3) === 0)
        return false;
      for (i = 5; i * i <= n;) {
        if (B.JSInt_methods.$mod(n, i) === 0 || B.JSInt_methods.$mod(n, i + 2) === 0)
          return false;
        i += 6;
      }
      return true;
    },
    findPrimeNumbersListTransform_closure: function findPrimeNumbersListTransform_closure() {
    },
    IsolateException: function IsolateException(t0, t1) {
      this.error = t0;
      this.stackTrace = t1;
    },
    workerMain(mapper, $S, $T) {
      var e, s, exception, t1, stream = null;
      try {
        stream = mapper.call$1(A.callbackToStream("onmessage", new A.workerMain_closure($S), type$.MessageEvent, $S));
      } catch (exception) {
        e = A.unwrapException(exception);
        s = A.getTraceFromException(exception);
        if (type$.Error._is(e) || type$.Exception._is(e)) {
          t1 = new A.IsolateException(e, s).toJson$0();
          $.$get$_context().callMethod$2("postMessage", [A.jsify(t1)]);
          return;
        }
        throw exception;
      }
      stream.listen$2$onError(new A.workerMain_closure0($T), new A.workerMain_closure1());
    },
    ...
    workerMain_closure: function workerMain_closure(t0) {
      this.S = t0;
    },
    workerMain_closure0: function workerMain_closure0(t0) {
      this.T = t0;
    },
    workerMain_closure1: function workerMain_closure1() {
    },
    ...
    main() {
      A.workerMain(A.prime__findPrimeNumbersListTransform$closure(), type$.Map_dynamic_dynamic, type$.List_dynamic);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A._BroadcastStreamController.prototype = {
    ...
    addStream$1(_, stream) {
      return this.addStream$2$cancelOnError(0, stream, null);
    },
    _add$1(_, data) {
  ...
  A.Stream.prototype = {
    ...
    asyncExpand$1$1(convert, $E) {
      var t2, _null = null, t1 = {};
      A._instanceType(this)._bind$1($E)._eval$1("Stream<1>?(2)")._as(convert);
      t1.controller = null;
      t2 = this.get$isBroadcast() ? t1.controller = new A._SyncBroadcastStreamController(_null, _null, $E._eval$1("_SyncBroadcastStreamController<0>")) : t1.controller = new A._SyncStreamController(_null, _null, _null, _null, $E._eval$1("_SyncStreamController<0>"));
      t2.set$onListen(new A.Stream_asyncExpand_closure(t1, this, convert));
      t1 = t1.controller;
  ...
  A.Stream_asyncExpand_closure.prototype = {
    call$0() {
      var t1 = this.$this,
        t2 = this._box_0,
        t3 = t2.controller.get$_addError(),
        t4 = t2.controller,
        subscription = t1.listen$3$onDone$onError(null, t4.get$close(t4), t3);
      subscription.onData$1(new A.Stream_asyncExpand__closure(t2, t1, this.convert, subscription));
      t2.controller.set$onCancel(0, subscription.get$cancel(subscription));
      if (!t1.get$isBroadcast()) {
        t1 = t2.controller;
        t1.set$onPause(0, subscription.get$pause(subscription));
        t1.set$onResume(0, subscription.get$resume(subscription));
      }
    },
    $signature: 0
  };
  A.Stream_asyncExpand__closure.prototype = {
    call$1($event) {
      var newStream, e, s, exception, t1, _this = this;
      A._instanceType(_this.$this)._precomputed1._as($event);
      newStream = null;
      try {
        newStream = _this.convert.call$1($event);
      } catch (exception) {
        e = A.unwrapException(exception);
        s = A.getTraceFromException(exception);
      ...
      if (newStream != null) {
        ...
        t1.pause$0(0);
        _this._box_0.controller.addStream$1(0, newStream).whenComplete$1(t1.get$resume(t1));
      }
    },
    $signature() {
  ...
  A.findPrimeNumbersListTransform_closure.prototype = {
    call$1($event) {
      var t1, t2, prime, count, merge;
      type$.Map_dynamic_dynamic._as($event);
      t1 = J.getInterceptor$ax($event);
      t2 = t1.$index($event, "prime");
      prime = A._asInt(t2 == null ? -1 : t2);
      t2 = t1.$index($event, "count");
      count = A._asInt(t2 == null ? 100 : t2);
      t1 = t1.$index($event, "merge");
      merge = A._asInt(t1 == null ? 2 : t1);
      return A.mergeResult(A.findPrimeNumbers(prime * 10, count), merge, type$.dynamic);
    },
    $signature: 27
  };
  A.IsolateException.prototype = {
    toJson$0() {
      var t1 = type$.String;
      return A.LinkedHashMap_LinkedHashMap$_literal(["type", "IsolateException", "error", this.error.toString$0(0), "stackTrace", J.toString$0$(this.stackTrace)], t1, t1);
    }
  };
  A.workerMain_closure.prototype = {
    call$1(e) {
      var data = type$.MessageEvent._as(e).data;
      return this.S._as(A.dartify(data));
    },
    $signature() {
      return this.S._eval$1("0(MessageEvent)");
    }
  };
  A.workerMain_closure0.prototype = {
    call$1(message) {
      return this.$call$body$workerMain_closure(this.T._as(message));
    },
    $call$body$workerMain_closure(message) {
      var $async$goto = 0,
      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $.$get$_context().callMethod$2("postMessage", [A.jsify(message)]);
              // implicit return
  ...
  A.workerMain_closure1.prototype = {
    call$2(e, s) {
      var t1;
      if (type$.Error._is(e) || type$.Exception._is(e)) {
        t1 = new A.IsolateException(e, type$.nullable_StackTrace._as(s)).toJson$0();
        $.$get$_context().callMethod$2("postMessage", [A.jsify(t1)]);
      }
    },
    $signature: 28
  ...
  (function installTearOffs() {
    ...
    _instance_0_i(_ = A._BroadcastStreamController.prototype, "get$close", "close$0", 4);
    ...
    _instance_0_i(_ = A._StreamController.prototype, "get$close", "close$0", 4);
    _instance_1_i(_, "get$_add", "_add$1", 8);
    _instance_2_u(_, "get$_addError", "_addError$2", 5);
    _instance_0_u(_, "get$_close", "_close$0", 0);
    _instance_0_u(_ = A._ControllerSubscription.prototype, "get$_onPause", "_onPause$0", 0);
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance(_ = A._BufferingStreamSubscription.prototype, "get$pause", 1, 0, null, ["call$1", "call$0"], ["pause$1", "pause$0"], 12, 0, 0);
    _instance_0_i(_, "get$resume", "resume$0", 0);
    _instance_0_i(_, "get$cancel", "cancel$0", 4);
    _instance_0_u(_, "get$_onPause", "_onPause$0", 0);
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance(_ = A._DoneStreamSubscription.prototype, "get$pause", 1, 0, null, ["call$1", "call$0"], ["pause$1", "pause$0"], 12, 0, 0);
    _instance_0_i(_, "get$resume", "resume$0", 0);
    _instance_0_i(_, "get$cancel", "cancel$0", 4);
    _instance_0_u(_, "get$_onMicrotask", "_onMicrotask$0", 0);
    _instance_1_u(_ = A._StreamIterator.prototype, "get$_onData", "_onData$1", 8);
    ...
    _static_1(A, "prime__findPrimeNumbersListTransform$closure", "findPrimeNumbersListTransform", 30);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A._KeysOrValuesOrElementsIterator, A.JSInvocationMirror, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A._Required, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._AsyncStarStreamController, A._IterationMarker, A.AsyncError, A.Stream, A._BufferingStreamSubscription, A._BroadcastStreamController, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamController, A._SyncStreamControllerDispatch, A._AsyncStreamControllerDispatch, A._AddStreamState, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.ListBase, A._UnmodifiableMapMixin, A.DateTime, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.ImmutableListMixin, A.FixedSizeListIterator, A.JsObject, A.NullRejectionException, A.IsolateException]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._asyncStarHelper_closure0, A._SyncBroadcastStreamController__sendData_closure, A._SyncBroadcastStreamController__sendError_closure, A._SyncBroadcastStreamController__sendDone_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_asyncExpand__closure, A.Stream_length_closure, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A.findPrimeNumbersListTransform_closure, A.workerMain_closure, A.workerMain_closure0, A.callbackToStream_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._asyncStarHelper_closure, A._AsyncStarStreamController__resumeBody, A._AsyncStarStreamController__resumeBody_closure, A._AsyncStarStreamController_closure, A._AsyncStarStreamController_closure0, A._AsyncStarStreamController_closure1, A._AsyncStarStreamController__closure, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__chainCoreFutureAsync_closure, A._Future__asyncCompleteWithValue_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_asyncExpand_closure, A.Stream_length_closure0, A._StreamController__subscribe_closure, A._StreamController__recordCancel_complete, A._AddStreamState_cancel_closure, A._BufferingStreamSubscription__sendError_sendError, A._BufferingStreamSubscription__sendDone_sendDone, A._PendingEvents_schedule_closure, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Stream_Map_dynamic_dynamic: findType("Stream<Map<@,@>>"),
